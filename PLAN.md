...
- collects new photo and video messages from one WhatsApp group,
- stores them in `/photos/YYYY/MM/DD` and `/videos/YYYY/MM/DD`,
...
4. Date-based media organization
5. SFTP upload to HostingRaja (bounded parallel workers)
...
3. End-to-end photo+video message-to-server flow
4. Duplicate prevention across restarts
5. Network failure recovery
6. Post-upload local deletion validation (optional)
7. Change history event validation
